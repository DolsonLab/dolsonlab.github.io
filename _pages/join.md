...
- As I see it, my primary job as a mentor is to help you achieve your goals. We are on the same team, trying to learn new things about ecology, evolution, and computer science while also doing what is necessary to continue having jobs. This works best if you are excited about the research we're doing (although it is natural for everyone's excitement about research to have ups and downs - science is frustrating sometimes and that's normal).
